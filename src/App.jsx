...
// Example: Unique Catchy Portfolio Homepage for Jobs
export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white font-sans">
      {/* Navbar */}
      <nav className="flex justify-between items-center px-8 py-4 border-b border-purple-600/30">
        <h1 className="text-2xl font-bold text-purple-400">Shreya.dev</h1>
      ...
      <section id="projects" className="px-8 py-16 bg-purple-950/40">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-xl p-6 shadow-lg hover:scale-[1.02] transition">
            ...
            <p className="text-gray-400 mb-4">Implemented modules for uploading, managing, and sharing medical records with doctors in real-time.
 • Built a smart reminder system for medications and checkups with Firebase-powered notifications.</p>
            <a href="#" className="text-purple-400 hover:underline">View Project →</a>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="px-8 py-16 max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-300 mb-6">
          Interested in collaborating or have an opportunity? Drop me a message.
        </p>
        <a href="www.linkedin.com/in/shreyarnayak14" className="px-6 py-3 bg-pink-500 hover:bg-pink-600 rounded-full shadow-lg transition">
          Say Hello
        </a>
      </section>
